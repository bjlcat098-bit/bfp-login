    ...
    const initialize = async () => {
      ...
      const frag = `
        ...
        float rayStrength(vec2 raySource, vec2 rayRefDirection, vec2 coord,
          ...
          float distorted = cosAngle + distortion * sin(iTime * 2.0 + length(sourceToCoord)*0.01) * 0.2;
          float spreadFactor = pow(max(distorted, 0.0), 1.0 / max(lightSpread, 0.001));
        ...
        void mainImage(out vec4 fragColor, in vec2 fragCoord) {
          ...
          vec4 r1 = vec4(1.0) * rayStrength(rayPos, finalDir, coord, 36.2, 21.1, 1.5*raysSpeed);
          vec4 r2 = vec4(1.0) * rayStrength(rayPos, finalDir, coord, 22.4, 18.0, 1.1*raysSpeed);
